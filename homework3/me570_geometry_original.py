...
def line_linspace(a_line, b_line, t_min, t_max, nb_points):
    ...
    """
    t_vec = np.array([np.linspace(t_min, t_max, nb_points)])
    theta_points = a_line @ t_vec + b_line @ np.ones((1, nb_points))
    return theta_points
...
class Grid:
    ...
    def plot_threshold(f_handle, threshold=10):
        """
